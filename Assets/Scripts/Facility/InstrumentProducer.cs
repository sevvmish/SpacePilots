...
public class InstrumentProducer : MonoBehaviour, IPointOfInteraction, ITakenAndMovable, IHighlightable
{
    [SerializeField] private InstrumentsType currentInstrumentToProduce;
    ...
    {
        currentPoolOfObjects = new ObjectPooling(amountOfStockSupply, Instrument.GetInstrumentPrefab(currentInstrumentToProduce), transform);
    }
    ...
    {
        return currentInstrumentToProduce;
    }
